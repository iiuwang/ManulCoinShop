...
@Component({
  ...
  imports: [Header, MatButtonModule, MatIconModule, MatSelectModule, MatFormFieldModule, MatOptionModule, MatPaginatorModule, TranslatePipe, MatProgressSpinnerModule],
...
export class CatalogProducts {
  ...
  protected readonly products = toSignal(this.productService.getProducts().pipe(finalize(() => this.isLoading.set(false))), { initialValue: [] });
  //для сортировки
